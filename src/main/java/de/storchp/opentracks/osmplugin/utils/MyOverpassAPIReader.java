...
/**
 * Edited from: https://github.com/mapsforge/vtm/blob/6eecba7c022de8967160d78a758ba20db96db359/vtm-extras/src/org/oscim/utils/overpass/OverpassAPIReader.java
 */
public class MyOverpassAPIReader {
     ...
     */
    public MyOverpassAPIReader(final double left, final double right,
     ...
     * Creates a new instance with the specified geographical coordinates.
     */
    public MyOverpassAPIReader(final BoundingBox bBox,
                               final String query) {
        this.query = query(bBox.getMinLongitude(), bBox.getMaxLongitude(), bBox.getMaxLatitude(), bBox.getMinLatitude(), query);
    }
    ...
    public void parseInputStream() {
        ...
        String url = myBaseUrl + "?data=" + encoded;
    ...
    public OsmData getData() {
        ...
        for (Map.Entry<OsmRelation, List<TmpRelation>> entry : relationMembersForRelation
                .entrySet()) {
